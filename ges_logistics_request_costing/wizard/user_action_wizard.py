...
class CostingRequestUserActionWizard(models.TransientModel):
    ...
    def confirm_action(self):
        ...
        elif self.name == 'req_cost_validate_sale':
            self.request_ids._action_validate_sale(note=self.note)
        elif self.name == 'req_cost_return_sale':
            self.request_ids._action_return_sale(note=self.note)
