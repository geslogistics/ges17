...
class CostingRequest(models.Model):
    ...
    def _compute_is_user(self):
        ...
        self.is_sale_team_user = self.current_operating_unit_sales_id == self.sales_ou_id and (self.env.user.has_group('ges_logistics_partner.group_partner_application_user_all_docs') or self.env.user.has_group('ges_logistics_partner.group_partner_application_user_team_docs'))
        self.is_sale_team_leader = self.current_user_id == self.sales_ou_id.requester_user_id
        ...
        self.is_purchase_team_leader = self.current_user_id.id in self.assigned_ou_id.requester_user_id.ids
        ...
        self.is_sale_ou_user = self.sales_ou_id in self.current_operating_unit_sales_ids and (self.env.user.has_group('ges_logistics_partner.group_partner_application_user_all_docs') or self.env.user.has_group('ges_logistics_partner.group_partner_application_user_team_docs'))
    ...
    assigned_ou_id = fields.Many2many(
        ...
        for record in self:
            ...
            if record.current_user_id and record.current_sales_ou_id and record.request_id:
                if record.request_id.sales_ou_id:
                    record.is_sale_team_user = record.current_sales_ou_id == record.request_id.sales_ou_id and (self.env.user.has_group('ges_logistics_partner.group_partner_application_user_all_docs') or self.env.user.has_group('ges_logistics_partner.group_partner_application_user_team_docs'))
