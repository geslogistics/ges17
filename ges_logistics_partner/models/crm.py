...
class Lead(models.Model):
    ...
    pa_arabic_name = fields.Char(string='Arabic Name', store=True, related="partner_id.current_kyc_id.arabic_name")
...
class Stage(models.Model):
    ...
    requires_kyc = fields.Boolean(string="Requires KYC")
    requires_crm = fields.Boolean(string="Requires CRM")
    requires_cc = fields.Boolean(string="Requires CC")
    requires_cs = fields.Boolean(string="Requires CS")
    requires_vrm = fields.Boolean(string="Requires VRM")
    requires_vc = fields.Boolean(string="Requires VC")
    requires_vs = fields.Boolean(string="Requires VS")
