...

{
    ...
    'depends': ['product', 'ges_logistics_partner', 'sale','sale_management','l10n_sa','l10n_sa_edi','crm','purchase','base_fontawesome','fleet','sale_margin'],
    'data': [
        # Security
