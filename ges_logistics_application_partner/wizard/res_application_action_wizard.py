...
class ApplicationPartnerUserActionWizard(models.TransientModel):
    _name = 'application.partner.user.action.wizard'
    ...
    application_ids = fields.Many2many('application.partner', 'res_pa_user_action_wizard', 'pa_user_action_app' ,'pa_user_action_wizard_id', string="Application(s)")
