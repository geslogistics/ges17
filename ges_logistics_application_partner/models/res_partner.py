...
class ResPartner(models.Model):
    ...
    #Application fields
    current_kyc_id = fields.Many2one('application.partner', string="KYC Application", tracking=True, domain="[('partner_id', '=', id),('application_type','=','kyc'),('state','=','active')]")
    ...
    current_crm_id = fields.Many2one('application.partner', string="CRM Application", tracking=True, domain="[('partner_id', '=', id),('application_type','=','crm'),('state','=','active')]")
    ...
    current_vrm_id = fields.Many2one('application.partner', string="VRM Application", tracking=True, domain="[('partner_id', '=', id),('application_type','=','vrm'),('state','=','active')]")
    ...
    current_customer_credit_id = fields.Many2one('application.partner', string="Customer Credit Application", tracking=True, domain="[('partner_id', '=', id),('application_type','=','customer_credit'),('state','=','active')]")
    ...
    current_vendor_credit_id = fields.Many2one('application.partner', string="Vendor Credit Application", tracking=True, domain="[('partner_id', '=', id),('application_type','=','vendor_credit'),('state','=','active')]")
    ...
    current_customer_strategy_id = fields.Many2one('application.partner', string="Customer Strategy Credit Application", tracking=True, domain="[('partner_id', '=', id),('application_type','=','customer_strategy'),('state','=','active')]")
    ...
    current_vendor_strategy_id = fields.Many2one('application.partner', string="Vendor Strategy Credit Application", tracking=True, domain="[('partner_id', '=', id),('application_type','=','vendor_strategy'),('state','=','active')]")
